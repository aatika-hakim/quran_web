...
const Card: React.FC<CardProps> = ({ title, text }) => {
    return (
        <div className="bg-white block border border-teal-100 p-2 md:p-3 shadow-xl transition hover:border-teal-500/10 hover:shadow-teal-500 hover:translate-y-2">
